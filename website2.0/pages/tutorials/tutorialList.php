...
while ($learnData = $learnList->fetch()) {
    ...
    if ($learnData[2]) { #Does the Module have an Image?
        echo "<div class='image'><img src='/assets/img/challengeImages/" . $learnData[2] . "' width='100' height='100'/></div>"; #Display Module Image
    } else {
        echo "<div class='image'><img src='/assets/img/challengeImages/blank.jpg'width='100' height='100'/></div>"; #Display Placeholder Image
    }
    echo "
